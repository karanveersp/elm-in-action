...
var $author$project$PhotoGroove$GotRamdomPhoto = function (a) {
	return {$: 'GotRamdomPhoto', a: a};
};
			...
			case 'ClickedSurpriseMe':
				...
				if ((_v1.$ === 'Loaded') && _v1.a.b) {
					...
					return _Utils_Tuple2(
						...
						A2(
							$elm$random$Random$generate,
							$author$project$PhotoGroove$GotRamdomPhoto,
							A2($elm$random$Random$uniform, firstPhoto, otherPhotos)));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'ClickedThumbnailSize':
				var size = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$PhotoGroove$ClickedThumbnailSize = function (a) {
	return {$: 'ClickedThumbnailSize', a: a};
};
				...
				[
					...
					_List_fromArray(
						[
							...
							function (_v0) {
								return $author$project$PhotoGroove$ClickedThumbnailSize(size);
							}),
							$elm$html$Html$Attributes$checked(
							_Utils_eq(modelSize, size))
						]),
					_List_Nil),
					$elm$html$Html$text(
